            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand w-25" href="{{route('front.homepage')}}"> <img src="{{asset('uploads/settings/'.$sett->logo)}}" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item  ">
                                    <a class="nav-link" href="{{route('front.getCourses')}}">Courses</a>
                                </li>
