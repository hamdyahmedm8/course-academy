            ...
            <div class="row">
                <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        <h2>{{json_decode($features_content->content)->mainTitle}}</h2>
                        <p>{{json_decode($features_content->content)->mainDesc}}</p>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>{{json_decode($features_content->content)->feature1Title}}</h4>
                            <p>{{json_decode($features_content->content)->feature1Desc}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>{{json_decode($features_content->content)->feature2Title}}</h4>
                            <p>{{json_decode($features_content->content)->feature2Desc}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part single_feature_part_2">
                            ...
                            <h4>{{json_decode($features_content->content)->feature3Title}}</h4>
                            <p>{{json_decode($features_content->content)->feature3Desc}}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="testimonial_part padding_top pb-5">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-5">
                    <div class="section_tittle text-center">
                        <p>{{json_decode($testimonials_content->content)->title}}</p>
                        <h2>{{json_decode($testimonials_content->content)->subtitle}}</h2>
                    </div>
                </div>
            </div>
            <div class="row">
