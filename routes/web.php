...
Route::namespace('Front')->group(function(){
    ...
    Route::get('/courses/get','courseController@getCourses')->name('front.getCourses');
    ...
    Route::post('/message/newsletter','massageController@newsletter')->name('front.message.newsletter');
    Route::post('/message/contact','massageController@contact')->name('front.message.contact');
    Route::post('/message/enroll','massageController@enroll')->name('front.message.enroll');
...
Route::namespace('Admin')->prefix('dashboard')->group(function(){
    ...
    Route::get('login/github/callback', 'AuthController@handleProviderCallback')->name('callBack.github');
    ...
    Route::middleware('adminAuth:admin')->group(function(){
        ...
        Route::get('/students/{id}/courses/{course-id}/approve','StudentController@approveCourse')->name('admin.students.approveCourse');
        Route::get('/students/{id}/courses/{course-id}/reject','StudentController@rejectCourse')->name('admin.students.rejectCourse');
